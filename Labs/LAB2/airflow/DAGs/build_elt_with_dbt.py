...
print(f"DBT_CONN: {conn}")
print(f"DBT_USER: {conn.login}")
print(f"DBT_PASSWORD: {conn.password}")
print(f"DBT_ACCOUNT: {conn.extra_dejson.get('account')}")
print(f"DBT_SCHEMA: {conn.schema}")
print(f"DBT_DATABASE: {conn.extra_dejson.get('database')}")
print(f"DBT_ROLE: {conn.extra_dejson.get('role')}")
print(f"DBT_WAREHOUSE: {conn.extra_dejson.get('warehouse')}")
print(f"DBT_TYPE: snowflake")
with DAG(
    "BuildELT_dbt",
